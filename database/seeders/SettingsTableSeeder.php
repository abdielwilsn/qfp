...
class SettingsTableSeeder extends Seeder
{
    public function run()
    {
        DB::table('settings')->insert([
            [
                'id' => 1,
                'site_name' => 'Trustcrypto',
                'description' => 'We are remedy',
                'currency' => '$',
                's_currency' => 'USD',
                ...
                'google_translate' => 'on',
                'weekend_trade' => 'off',
                'contact_email' => 'remedytechservces@gmail.com',
                'timezone' => 'UTC',
                'mail_server' => 'sendmail',
                'emailfrom' => 'remedytechservices@gmail.com',
                'emailfromname' => 'Remedy Hyip',
                'smtp_host' => 'metafxcrypto.com',
                'smtp_port' => '2525',
                'smtp_encrypt' => 'tls',
                'smtp_user' => 'c1fc6aa480f0ca',
                'smtp_password' => '37cade45cfc7d3',
                ...
                'quarterlyfee' => '40',
                'yearlyfee' => '80',
                'newupdate' => 'Welcome to Remedy hyip',
                'created_at' => null,
